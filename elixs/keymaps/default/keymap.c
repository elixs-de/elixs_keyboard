...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     */
    [0] = LAYOUT_split_3x6(KC_B, KC_V, KC_C, KC_X, KC_Z, KC_LCTL, KC_G, KC_F, KC_D, KC_S, KC_A, KC_LSFT, KC_T, KC_R, KC_E, KC_W, KC_Q, KC_TAB, MO(2), KC_LWIN, KC_SPC, KC_ENT, KC_LALT, KC_NO, KC_NO, KC_DEL, KC_ESC, KC_BSPC, MO(1), MO(3), LSFT(KC_MINS), KC_SLSH, KC_DOT, KC_COMM, KC_M, KC_N, KC_QUOT, KC_SCLN, KC_L, KC_K, KC_J, KC_H, KC_LBRC, KC_P, KC_O, KC_I, KC_U, KC_Y),
    ...
    [2] = LAYOUT_split_3x6(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_LCTL, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_LSFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TAB, MO(2), KC_LWIN, KC_SPC, KC_ENT, KC_LALT, KC_NO, KC_NO, KC_DEL, KC_ESC, KC_BSPC, KC_NO, MO(3), KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_RIGHT, KC_UP, KC_DOWN, KC_LEFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO),
